...
P-value is 0.07 which is not really a small number, therefore, indicating that there is no real difference between the belief in the BIGBANG theory and the POSTLIFE. Due to the p-value we fail to reject the null hypothesis.
